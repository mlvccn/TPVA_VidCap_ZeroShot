...
class ClipScore:
    def __init__(self, args):
        self.image_features_dir = args.image_features_dir
        self.device = args.device
        # self.save_per_instance = args.save_per_instance
    ...
    def compute_score(self, references, candidates):
        ...
        for idx in candidates.keys():
            ...
            image_paths.append(os.path.join(self.image_features_dir, idx)+'.npy')
