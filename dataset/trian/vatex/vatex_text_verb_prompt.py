...
def vatex_text_only_collate_fn(batch):
...
class vatex_text_only_dataset_train(torch.utils.data.Dataset):
...
class vatex_text_only_dataset_val(torch.utils.data.Dataset):
    def __init__(self, args,) -> None:
        super().__init__()
        self.caption_file_path_train = args.caption_file_path_train
        self.caption_file_path_val = args.caption_file_path_val
